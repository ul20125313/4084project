        ...
        tj.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(Integer.parseInt(mainpage.info.zlmap.get("ye"))>=Integer.parseInt(mainpage.info.jsje())){
                    dio=new dialog(ddxq.this, "Pay or not", new dialog.oncl() {
                        @Override
                        public void onfou() {
                            dio.dismiss();
                        }
                        ...
                        public void onshi() {
                            ...
                            setResult(2,a);
                            Toast.makeText(ddxq.this,"Payment success",Toast.LENGTH_SHORT).show();
                            maps.add(x);
